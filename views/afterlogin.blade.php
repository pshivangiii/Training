...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href='/calendar/{{$users->email}}'>Attendance</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href='/ownprofile/{{$users->email}}'>Profile Details</a>
      </li>
     
      @if($users->designation == 'Manager')
      <li class="nav-item">
        <a class="nav-link" href='/team_details/{{$users->team}}'>Team Details</a>
      </li>
      @endif
      @endforeach
      <li class="nav-item">
